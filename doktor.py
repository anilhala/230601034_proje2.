...
# Personel sınıfından doktor sınıfını türetiyoruz
class Doktor(Personel):
    ...
    # Doktorlara ve hastaneye ait get/set metotları
    ...
    def maas_arttir(self, oran):
        yeni_maas = self.get_maas() * (1 + oran)  # maası 1 olarak alır ve oran ile artırır.
        self.set_maas(yeni_maas)  # Yeni maaşı ayarlar

    # Doktor bilgilerini yazdıran __str__ metotu
    def __str__(self):
